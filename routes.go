...
func setupRoutes(appServer *AppServer) *gin.Engine {
	...
	api := router.Group("/api/v1")
	{
		...
		api.GET("/notifications/comments", appServer.getCommentNotificationsHandler)
		api.POST("/notifications/comments/reply", appServer.replyNotificationCommentHandler)
		api.POST("/notifications/comments/like", appServer.likeNotificationCommentHandler)
	}
